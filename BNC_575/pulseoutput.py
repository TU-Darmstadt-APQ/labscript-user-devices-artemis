...
class PulseOutput(QWidget):
    def __init__(self, hardware_name, connection_name='-', parent=None):
        ...
        self._widgets['mode'] = ComboBox(display_name='<i>mode</i>', options=['NORMal', 'SINGle', 'BURSt', 'DCYCle'], horizontal_alignment=True)
        ...
        self._widgets['state'].setToolTip("Enable")
        self._widgets['width'].setToolTip("width")
        self._widgets['delay'].setToolTip("delay")
        self._widgets['wait'].setToolTip("wait")
        self._widgets['mode'].setToolTip("mode")
...
class ComboBox(QWidget):
    def __init__(self, display_name="", options=None, horizontal_alignment=False):
        super().__init__()

        self._label = QLabel(display_name)
        self._combobox = QComboBox()
        self._combobox.addItems(options or [])

        layout = QHBoxLayout() if horizontal_alignment else QVBoxLayout()
