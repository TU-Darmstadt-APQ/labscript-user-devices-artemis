...
class BS_341A(Device): # no pseudoclock IntermediateDevice --> Device
    """ A labscript device to send commands to device (BS_341A) at the beginning and end of the shots."""
    description = 'BS_341A'
