"""
Simulate the serial port for the BS 1-10, as I don't have access to the real device.
...
In the userlib directory, run the following command:
    python3 -m user_devices.BS_cryo_old.emulateSerPort
    ...
    while True:
        try:
            ...
            if command:
                ...
                elif command.startswith("BS110 CH"):
                    device, channel, voltage = command.split()
