...
thresholdUpper = mV2adc(10000, chARange, maxADC)
thresholdLower = mV2adc(0, chARange, maxADC)
channelProperties = ps.PS4000A_TRIGGER_CHANNEL_PROPERTIES(thresholdUpper, floor(thresholdUpper * 0.01), thresholdLower, floor(thresholdLower * 0.01), ps.PS4000A_CHANNEL["PS4000A_CHANNEL_A"], ps.PS4000A_THRESHOLD_MODE["PS4000A_LEVEL"])
